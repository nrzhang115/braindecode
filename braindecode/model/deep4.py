...
class Deep4Net(EEGModuleMixin, nn.Sequential):
    ...
    def __init__(
        ...
        # Define the dense classifier layer
        module.add_module(
            "dense_classifier",
            nn.Linear(
                self.n_filters_3 * self.final_conv_length,  # Number of input features from the flattened last conv layer
                64,  # The number of nodes in the dense layer
                bias=True,
            ),
        )   
